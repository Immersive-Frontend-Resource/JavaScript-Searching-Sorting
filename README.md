...
```
git clone https://github.com/Immersive-Frontend-Resource/JavaScript-Searching-Sorting.git
```

setelah itu buat repository pada github organization kalian dengan format `JavaScript-Searching-Sorting`, lalu copy link HTTPS seperti gambar dibawah
